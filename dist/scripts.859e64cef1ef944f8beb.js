!(function(e, t) {
                  ...
                  if (((h = [a ? v.firstChild : v.lastChild]), a && y)) {
                    ...
                    for (
                      ...
                      ((s ? p.nodeName.toLowerCase() !== m : 1 !== p.nodeType) ||
                        !++x ||
                        (y && ((c = (f = p[b] || (p[b] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[e] = [T, x]),
                        p !== t));
      ...
      for (
        ...
        if ((n = r.relative[e[u].type])) p = [be(we(p), n)];
          ...
          if ((n = r.filter[e[u].type].apply(null, e[u].matches))[b]) {
            ...
            return Ce(
              1 < u && we(p),
              1 < u && xe(e.slice(0, u - 1).concat({ value: ' ' === e[u - 2].type ? '*' : '' })).replace(B, '$1'),
              n,
              u < i && Ee(e.slice(u, i)),
              i < o && Ee((e = e.slice(i))),
              i < o && xe(e)
    ...
    if (((n = n || q), 'string' == typeof e)) {
      ...
      if (i[1]) {
        if (
          (w.merge(
            this,
            w.parseHTML(i[1], (t = t instanceof w ? t[0] : t) && t.nodeType ? t.ownerDocument || t : r, !0)
          ),
      ...
      function(e, t) {
        w.fn[e] = function(n, r) {
          ...
          return (
            ...
            1 < this.length && (O[e] || w.uniqueSort(i), H.test(e) && i.reverse()),
            this.pushStack(i)
          );
        };
      }
      ...
      l = function() {
        for (o = o || e.once, i = n = !0; s.length; u = -1)
          for (r = s.shift(); ++u < a.length; )
            !1 === a[u].apply(r[0], r[1]) && e.stopOnFalse && ((u = a.length), (r = !1));
                      ...
                      : function() {
                          try {
                            ...
                            w.Deferred.exceptionHook && w.Deferred.exceptionHook(l, c.stackTrace),
                              o <= t + 1 && (r !== I && ((s = void 0), (u = [l])), n.rejectWith(s, u));
                          }
                        };
  ...
  function Ie(e, t, n, r) {
    ...
    var i,
      ...
      v = t[0],
      m = g(v);
    if (m || (1 < p && 'string' == typeof v && !h.checkClone && Le.test(v)))
    ...
    if (
      ...
      for (u = (s = w.map(ve(i, 'script'), Pe)).length; f < p; f++)
        (l = i), f !== d && ((l = w.clone(l, !0, !0)), u && w.merge(s, ve(l, 'script'))), n.call(e[f], l, f);
      if (u)
        for (c = s[s.length - 1].ownerDocument, w.map(s, Re), f = 0; f < u; f++)
          he.test((l = s[f]).type || '') &&
            ...
            (l.src && 'module' !== (l.type || '').toLowerCase()
              ? w._evalUrl && !l.noModule && w._evalUrl(l.src, { nonce: l.nonce || l.getAttribute('nonce') })
  ...
  function We(e, t, n) {
    for (var r, i = t ? w.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
      n || 1 !== r.nodeType || w.cleanData(ve(r)),
        r.parentNode && (n && oe(r) && me(ve(r, 'script')), r.parentNode.removeChild(r));
    return e;
  }
  w.extend({
  ...
  function tt(e, t, n) {
    ...
    return (
      ((!h.boxSizingReliable() && i) || 'auto' === a || (!parseFloat(a) && 'inline' === w.css(e, 'display', !1, r))) &&
      ...
      w.cssHooks[t] = {
        ...
        set: function(e, n, r) {
          ...
          return (
            ...
            u && (i = ne.exec(n)) && 'px' !== (i[3] || 'px') && ((e.style[t] = n), (n = w.css(e, t))),
            Ze(0, n, u)
          );
        }
      };
  ...
  function lt() {
    it &&
      (!1 === r.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(lt) : e.setTimeout(lt, w.fx.interval),
      w.fx.tick());
  }
  function ct() {
    return (
      ...
      return (
        w.fx.off
          ...
          : 'number' != typeof r.duration &&
            (r.duration = r.duration in w.fx.speeds ? w.fx.speeds[r.duration] : w.fx.speeds._default),
  ...
  w.fn.extend({
    ...
    w.extend({
      prop: function(e, t, n) {
        ...
        if (3 !== o && 8 !== o && 2 !== o)
          return (
            (1 === o && w.isXMLDoc(e)) || (i = w.propHooks[(t = w.propFix[t] || t)]),
            void 0 !== n
              ? i && 'set' in i && void 0 !== (r = i.set(e, n, t))
                ? r
                : (e[t] = n)
      ...
      ajax: function(t, n) {
        ...
        h.hasContent
          ...
          : ((d = h.url.slice(o.length)),
            ...
            !1 === h.cache && ((o = o.replace(Ot, '$1')), (d = (kt.test(o) ? '&' : '?') + '_=' + St++ + d)),
            (h.url = o + d)),
        h.ifModified &&
    ...
    (w.parseHTML = function(e, t, n) {
      return 'string' != typeof e
        ...
        : ('boolean' == typeof t && ((n = t), (t = !1)),
          ...
          (o = j.exec(e))
            ? [t.createElement(o[1])]
            : ((o = we([e], t, a)), a && a.length && w(a).remove(), w.merge([], o.childNodes)));
      var i, o, a;
    }),
